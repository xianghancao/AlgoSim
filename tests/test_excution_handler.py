...
class TestExcutionHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        barObj = sim_bar_handler.SimBarHandler('/Users/Hans/Desktop/Dali/data/zz500_15min', eq,
                                    start_date='2019-08-13', end_date='2019-08-15', look_back=10,
    ...
    def test_fill(self):
        ...
        self.assertEqual(round(self.seObj.fill_price_df.loc['2019-08-13 09:30:00', '000008'], 6), 3.48)
        self.assertEqual(self.seObj.fill_quantity_df.loc['2019-08-13 09:30:00', '000008'], 215.0)
