...
class TestOrderHandler(unittest.TestCase):
    ...
    def test_order(self):
        self.assertEqual(self.orderObj.history_order_quantity_df.loc['2019-08-13 09:30:00', '000008'], 215.0)
        self.assertEqual(self.orderObj.history_order_action_df.loc['2019-08-13 09:30:00', '000008'], 'BUY')
