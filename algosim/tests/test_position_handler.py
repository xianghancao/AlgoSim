...
class TestExcutionHandler(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        barObj = sim_bar_handler.SimBarHandler('/Users/Hans/Desktop/Dali/data/zz500_15min', eq,
                                    start_date='2019-08-13', end_date='2019-08-16', look_back=10,
        ...
        self.posObj = position_handler.Position(price_handler=barObj,
                                   store_path='/Users/Hans/Desktop/Dali/account/test/')


        from dali.portfolio_handler import equal_wgts_portfolio_handler
        self.portfolioObj = equal_wgts_portfolio_handler.EqualWgtsPortfolioHandler(eq, ['Signal_test'], self.posObj, 1e7,
                                                     store_path='/Users/Hans/Desktop/Dali/account/test/')

        from dali.execution_handler import sim_exec_handler
        self.seObj = sim_exec_handler.SimExecHandler(eq, barObj, self.posObj, store_path='/Users/Hans/Desktop/Dali/account/test/')
    ...
    def test_fill(self):
        #print(self.portfolioObj.history_portfolio_signal)
        self.assertEqual(self.posObj.history_position_df.loc['2019-08-15 10:30:00', '000008'], 1622)
